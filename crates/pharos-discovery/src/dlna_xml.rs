//! DLNA / UPnP MediaServer phase-1 XML helpers.
//!
//! Pure-string helpers + SCPD schemas + Browse response builder.
//! The actix HTTP handlers live in `pharos-server::dlna` and only call
//! into these helpers, so this module stays free of actix-web.
...
pub fn empty_soap_response(action: &str) -> String {

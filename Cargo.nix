  ...
  internal = rec {
    ...
    crates = {
      ...
      "pharos-scanner" = rec {
        ...
        resolvedDefaultFeatures = [ "libav-probe" "watch" ];
      };
      "pharos-server" = rec {
        ...
        features = {
          ...
          "watch" = [ "pharos-scanner/watch" ];
        };
        resolvedDefaultFeatures = [ "default" "ffmpeg-lib" "ffmpeg-spawn" "watch" ];
      };
      "pharos-store-sqlx" = rec {
